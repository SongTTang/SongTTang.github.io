...
const initialMessages = [
    'No need to stop, you don’t see this every day!',
    'I’ve seen similar things happen before.',
    'Let them go at it, it’s not my concern anyway.',
    'Stream for a bit longer, we haven’t seen enough yet!'
...
const presetReplies = [
    'That’s right. I thought that everyone’s gone crazy.',
    'Finally, this farce is over. What’s wrong with the world?! Don’t you all find this terrifying?',
    'I almost feel a little regret! When will I get to see something like this again for fun?',
    'It doesn’t affect me anyway, so who cares!'
];
...
document.getElementById('ignoreBtn').addEventListener('click', function () {
    changeButtonColor(this);
    addReply(userUsername, 'WHATEVER.', true); // Mark as user reply
    displayButtonReplies([
        'Yeah! keep streaming!',
