...
const initialMessages = [
    'Are they serious?? I thought they were just messing around!',
    'Oh my gosh, I hope no innocent people get hurt.',
    'Fight! Fight! Fight back! Come on, you coward!',
    'I’m gonna go get my beer!'
...
const presetReplies = [
    'Bravo! Bro, you should jump in too!',
    'Stop filming! This is too dangerous!',
    'What are the people around doing?',
    'Mind your own business! Just let everyone watch!'
];
...
document.getElementById('supportBtn').addEventListener('click', function () {
    ...
    addReply(userUsername, 'Just ONE MORE look...! It’s NO BIG DEAL.', true); // Mark as user reply
    displayButtonReplies([
        'Yeah, just one more! who can resist this excitement!',
        'This isn’t right, stop the stream immediately!'
    ]);
    disableButtons();
});
...
document.getElementById('opposeBtn').addEventListener('click', function () {
    changeButtonColor(this);
    addReply(userUsername, 'NO! STOP the livestream!', true); // Mark as user reply
    displayButtonReplies([
        'Keep fighting, stopping now would be boring!',
...
document.getElementById('ignoreBtn').addEventListener('click', function () {
    changeButtonColor(this);
    addReply(userUsername, 'WHAT on earth is happening...', true); // Mark as user reply
    displayButtonReplies([
        'Don’t be so tense, nothing serious will happen.',
